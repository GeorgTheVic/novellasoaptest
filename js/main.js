...
/* harmony import */ var _components_date__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/date */ "./src/js/components/date.js");
/* harmony import */ var _components_date__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_date__WEBPACK_IMPORTED_MODULE_1__);
...
const rules1 = [{
  ...
  rules: [{
    rule: 'minLength',
    value: 2,
    errorMessage: 'Поле должно содержать не менее двух знаков!'
  }, {
    rule: 'required',
    value: true,
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_2__.validateForms)('.form', rules1, afterForm);
...
const infoDate = document.body.querySelector('.footer__info-date'),
      year = new Date();
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper', {
  ...
  breakpoints: {
    ...
    821: {
      ...
      //   prevEl: '.products__img-prew',
      //   nextEl: '.products__img-next',
      // },
...
const validateForms = (selector, rules, afterSend) => {
  ...
  const form = (_document = document) === null || _document === void 0 ? void 0 : _document.querySelector('.form');
